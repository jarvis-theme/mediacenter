            ...
            <form action="#" id="addorder">
                ...
                <div class="no-margin col-xs-12 col-sm-7 body-holder">
                    <div class="body">
                        ...
                        <div class="prices">
                            <div class="price-current">{{price($produk->hargaJual)}}</div>
                        ...
                        <div class="qnt-holder">
                            <div class="le-quantity">
                                ...
                                <input name="qty" readonly="readonly" type="text" value="0">
                        ...
                        <div id="owl-recently-viewed-2" class="owl-carousel product-grid-holder">
                            ...
                            <div class="no-margin carousel-item product-item-holder size-medium hover">
                                <div class="product-item">
                                    ...
                                    <div class="prices">
                                        <div class="price-current text-right">{{price($relproduk->hargaJual)}}</div>
                                    </div>
